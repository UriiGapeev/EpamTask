...
public class Array_task_second{
    ...
    public Array_task_second(int n){
        this.n = n;
        this.mas = new int[n][n];
    }
    ...
    public static void main(String[] args) {
        Array_task_second array_task_second1 = new Array_task_second();
        int n = arrayInput();
        array_task_second1.setN(n);
        Array_task_second array_task_second = new Array_task_second(n);
